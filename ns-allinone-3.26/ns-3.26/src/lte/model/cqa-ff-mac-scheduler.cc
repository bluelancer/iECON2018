  ...
  for (itLogicalChannels = m_ueLogicalChannelsConfigList.begin (); itLogicalChannels != m_ueLogicalChannelsConfigList.end (); itLogicalChannels++)
    {
      ...
      if (itLogicalChannels->second.m_qosBearerType == itLogicalChannels->second.QBT_NON_GBR )
        {
          NS_LOG_DEBUG ("Bearer Type: "<<itLogicalChannels->second.m_qosBearerType<<std::endl);
          NS_LOG_DEBUG ("QCI value for NON GBR "<<(int) itLogicalChannels->second.m_qci<<std::endl);
      ...
      {
          NS_LOG_INFO ("Bearer Type: "<<itLogicalChannels->second.m_qosBearerType<<std::endl);
          NS_LOG_INFO ("QCI value for NON GBR "<<(int) itLogicalChannels->second.m_qci<<std::endl);
