...
CC = ['/usr/bin/gcc']
CCDEFINES = []
CCFLAGS = ['-O0', '-ggdb', '-g3', '-rdynamic', '-Wall', '-Werror', '-O0', '-ggdb', '-g3', '-rdynamic', '-Wall', '-Werror', '-std=c++11', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
CXX = ['/usr/bin/g++']
CXXDEFINES = []
CXXFLAGS = ['-O0', '-ggdb', '-g3', '-rdynamic', '-Wall', '-Werror', '-std=c++11', '-Wno-error=deprecated-declarations', '-fstrict-aliasing', '-Wstrict-aliasing']
...
EXAMPLE_DIRECTORIES = ['tcp', 'matrix-topology', 'stats', 'wireless', 'error-model', 'naming', 'routing', 'ipv6', 'udp', 'socket', 'udp-client-server', 'traffic-control', 'realtime', 'energy', 'tutorial']
...
NS3_EXECUTABLE_PATH = ['/home/yifei/workspace/ns-allinone-3.26/ns-3.26/build/src/fd-net-device', '/home/yifei/workspace/ns-allinone-3.26/ns-3.26/build/src/tap-bridge']
...
NS3_MODULE_PATH = ['/usr/lib/gcc/x86_64-linux-gnu/4.8', '/home/yifei/workspace/ns-allinone-3.26/ns-3.26/build']
...
VALGRIND_FOUND = True
VERSION = '3.26'
WITH_PYBINDGEN = '/home/yifei/workspace/ns-allinone-3.26/pybindgen-0.17.0.post57+nga6376f2'
WL_SONAME_SUPPORTED = True
cfg_files = ['/home/yifei/workspace/ns-allinone-3.26/ns-3.26/build/ns3/config-store-config.h', '/home/yifei/workspace/ns-allinone-3.26/ns-3.26/build/ns3/core-config.h']
cprogram_PATTERN = '%s'
